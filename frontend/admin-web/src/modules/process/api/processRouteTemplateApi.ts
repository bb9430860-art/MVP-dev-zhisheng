...
export function setRouteTemplateEnabled(
  id: number,
  enabled: boolean,
): Promise<RouteTemplate> {
  return requestData(
    httpClient.patch(`${routeTemplateBase}/${id}/enabled`, { enabled }),
  );
}
...
export function getRouteTemplateOptions(
  productType?: string,
...
export function listStepTemplates(
  routeTemplateId: number,
): Promise<StepTemplate[]> {
  return requestData(
    httpClient.get(`${routeTemplateBase}/${routeTemplateId}/steps`),
  );
}
...
export function createStepTemplate(
  ...
  return requestData(
    httpClient.post(`${routeTemplateBase}/${routeTemplateId}/steps`, payload),
  );
}
...
export function updateStepTemplate(
  ...
  return requestData(
    httpClient.put(
      `${routeTemplateBase}/${routeTemplateId}/steps/${stepId}`,
      payload,
    ),
  );
}
...
export function setStepTemplateEnabled(
  ...
  return requestData(
    httpClient.patch(
      `${routeTemplateBase}/${routeTemplateId}/steps/${stepId}/enabled`,
      { enabled },
    ),
  );
}

export function deleteStepTemplate(
  routeTemplateId: number,
  stepId: number,
): Promise<void> {
  return requestData(
...
export function moveStepUp(
  ...
  return requestData(
    httpClient.put(
      `${routeTemplateBase}/${routeTemplateId}/steps/${stepId}/move-up`,
    ),
  );
}
...
export function moveStepDown(
  ...
  return requestData(
    httpClient.put(
      `${routeTemplateBase}/${routeTemplateId}/steps/${stepId}/move-down`,
    ),
  );
}
